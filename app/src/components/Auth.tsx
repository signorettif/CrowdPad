...
export const Auth = ({ onAuthenticate, authStatus, username, setUsername }: AuthProps) => {
    ...
    return (
        <div className="mb-6">
            ...
            <button onClick={handleAuthenticate} className="w-full bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Authenticate
            </button>
